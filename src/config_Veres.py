...
def config():
    ...
    parser.add_argument('--out_dir', default='../RESULTS_trys/Veres-tt')
    # -- data options
    parser.add_argument('--data_path', default='../data/Veres/fate_train.pt')
    parser.add_argument('--data_dir', default='../data/Veres')
    parser.add_argument('--weight_path', default='../data/Veres/Veres2019_growth-kegg.pt')
    ...
    parser.add_argument('--sigma_const', default=0.01)
    # -- train options
    ...
    # -- test options
    parser.add_argument('--evaluate_n', default=3000, type=int)
    ...
    parser.add_argument('--ns', default=1000, type=float)
